...
\begin{figure}[h]
	...
	\addplot[color=blue,only marks,mark=x,mark size=1, error bars/.cd,y dir=both, y explicit] table[x=t,y=p]{leckrate.txt};
...
\begin{matrix}
	Punkt	& t/s & p/mbar \\ 
	1	& 3,17759\cdot 10^{3} & 1,69000\cdot 10^{-4} \\ 
	2	& 3,23609\cdot 10^{3} & 1,95000\cdot 10^{-3} \\ 
	3	& 3,40384\cdot 10^{3} & 1,64000\cdot 10^{-4} \\ 
	4	& 3,44534\cdot 10^{3} & 1,32000\cdot 10^{-3} \\ 
	5	& 3,60434\cdot 10^{3} & 1,57000\cdot 10^{-4} \\ 
	6	& 3,62984\cdot 10^{3} & 1,16000\cdot 10^{-3}
\end{matrix} 
$	
\end{center}
